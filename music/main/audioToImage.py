...
def generate(title, model, pipe, device):
    with torch.no_grad():
        ...
        images[0].save(f"media/song_covers/{title}.png")
        return f"song_covers/{title}.png"